...
namespace Recipes_Api.Migrations
{
    ...
    [Migration("20200806172141_delete-cascade-part2-tool")]
    partial class deletecascadepart2tool
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Recipes_Api.Models.Ingredient", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Recipes_Api.Models.Measurement", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("Recipes_Api.Models.RecipeTool", b =>
                {
                    b.Property<long>("RecipeId")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("recipe_id")
            ...
            modelBuilder.Entity("Recipes_Api.Models.Tool", b =>
                {
                    b.Property<long>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnName("tool_id")
            ...
            modelBuilder.Entity("Recipes_Api.Models.RecipeIngredientMeasurement", b =>
                {
                    b.HasOne("Recipes_Api.Models.Ingredient", "Ingredient")
                    ...
                    b.HasOne("Recipes_Api.Models.Measurement", "Measurement")
                        .WithMany("RecipeIngredientMeasurement")
                    ...
                    b.HasOne("Recipes_Api.Models.Recipe", "Recipe")
                        .WithMany("RecipeIngredientMeasurement")
            ...
            modelBuilder.Entity("Recipes_Api.Models.RecipeTool", b =>
                {
                    ...
                    b.HasOne("Recipes_Api.Models.Tool", "Tool")
                        .WithMany("RecipeTool")
